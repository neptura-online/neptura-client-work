  ...
  return (
    <section className="relative bg-[#160a1f] py-24">
      <div className="relative mx-auto max-w-360 px-6">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 shrink-0 ">
          <motion.div
          ...
          >
            ...
            >
              ...
              <p className="metric-lead ">Clicks</p>
            </motion.div>
            ...
            >
              <h3 className="case-heading">
                Silverware Gifting <br className="lg:hidden" /> &{" "}
                <br className="hidden lg:block" /> Furniture
              </h3>
  ...
  "
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className=" mt-14 w-fit inline-flex items-center gap-2 rounded-2xl bg-(--yellow-emarketing) px-6 py-3 font-semibold text-sm text-black cursor-pointer"
          >
